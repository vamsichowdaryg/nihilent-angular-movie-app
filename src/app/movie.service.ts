...
export class MovieService {
  movielist: Array<Movie> = [
    ...
    },
    {
      ...
      "src": "https://upload.wikimedia.org/wikipedia/en/8/8b/No_Country_for_Old_Men_src.jpg",
      "rating": 8.1,
    ...
    {
      "name": "PS2",
      "src": "https://m.media-amazon.com/images/M/MV5BYjFjMTQzY2EtZjQ5MC00NGUyLWJiYWMtZDI3MTQ1MGU4OGY2XkEyXkFqcGdeQXVyNDExMjcyMzA@._V1_.jpg",
      "content": "Ponniyin Selvan: I is an upcoming Indian Tamil-language epic period action film directed by Mani Ratnam, who co-wrote it with Elango Kumaravel and B. Jeyamohan",
      "rating": 8,
